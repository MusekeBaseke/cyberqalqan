...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link href="images/shield.png" rel="shortcut icon">
    ...
    <ul class="navbar-nav ml-auto">
        <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="#" id="languageDropdown" role="button" data-toggle="dropdown">
                {{ app()->getLocale() === 'kk' ? 'Қазақша' : 'English' }}
            </a>
            <div class="dropdown-menu">
                <a class="dropdown-item" href="{{ LaravelLocalization::getLocalizedURL('en', null, [], true) }}">English</a>
                <a class="dropdown-item" href="{{ LaravelLocalization::getLocalizedURL('kk', null, [], true) }}">Қазақша</a>
            </div>
        </li>
    </ul>

        <div class="container">
            <a class="navbar-brand" href="#"><img src="images/logo.png" alt="logo" width="50px"></a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="#">{{ __('main.title') }}</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6 order-2 order-md-1 text-center text-md-left">
                    <h1 class="text-white font-weight-bold mb-4">{{ __('main.protect') }}<strong style="color: #ffc107">   {{ __('main.title') }}</strong></h1>
                    <p class="text-white mb-5">{{ __('main.slogan') }}</p>
                    <a href="#" class="btn btn-main">{{ __('main.download') }}</a>
                </div>
                <div class="col-md-6 text-center order-1 order-md-2">
                    <img class="img-fluid" src="images/img.png" alt="screenshot" style="height: 500px">
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="rounded shadow p-5 bg-white">
                <div class="row">
                    <div class="col-md-4 mb-4 mb-md-0 text-center">
                        ...
                        <h3 class="mt-4 text-capitalize h5 ">{{ __('main.fast_scan') }}</h3>
...
{{--                            tempore ipsam dignissimos molestias.</p>--}}
                    ...
                    <div class="col-md-4 mb-4 mb-md-0 text-center">
                        ...
                        <h3 class="mt-4 text-capitalize h5 ">{{ __('main.powerful_design') }}</h3>
{{--                        <p class="regular text-muted">Lorem ipsum dolor sit amet consectetur adipisicing elit. Aliquam non, recusandae--}}
{{--                            tempore ipsam dignissimos molestias.</p>--}}
                    </div>
                    <div class="col-md-4 mb-4 mb-md-0 text-center">
                        <i class="ti-money text-primary h1"></i>
                        <h3 class="mt-4 text-capitalize h5 ">{{ __('main.free') }}</h3>
{{--                        <p class="regular text-muted">Lorem ipsum dolor sit amet consectetur adipisicing elit. Aliquam non, recusandae--}}
{{--                            tempore ipsam dignissimos molestias.</p>--}}
                        </p>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-4 ml-auto justify-content-center">
                    ...
                    <div class="image-content" data-aos="fade-right">
                        <img class="img-fluid" src="images/img_1.png" alt="iphone" style="height: 500px">
                    </div>
                </div>
                <div class="col-lg-8 mr-auto align-self-center">
                    <div class="feature-content">
                        <!-- Feature Title -->
                        <h2>{{ __('main.malware_info') }}</h2>
                        <!-- Feature Description -->
...
{{--                            ea commodo consequat.</p>--}}
                ...
                <div class="col-lg-4 mr-auto justify-content-center">
                    ...
                    <div class="image-content" data-aos="fade-left">
                        <img class="img-fluid" src="images/img_2.png" alt="ipad" style="height: 500px">
                    </div>
                </div>
            </div>
        </div>
